            ...
            <template slot="title">
              <div class="header">
                ...
                <div class="item waitDetail">
                  ...
                  <span class="detail noDeal" v-if="order.orderStatus == 3">已跟进</span>
                  <span class="detail noConfirm" v-else-if="order.orderStatus >= 10">已取消</span>
                </div>
              </div>
            </template>
            <div class="content">
              <div class="title" v-if="order.orderStatus == 10">
                <span>出货明细详情</span>
              </div>
              <div class="detail" v-if="order.orderStatus == 10">
                <div class="left">
                  <div
                    class="item bt-hover"
                  ...
                  <el-table
                    ...
                    <el-table-column
                      ...
                      <template slot-scope="scope">
                        <el-input size="mini" v-model.trim="scope.row.productWeight" disabled></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column
                      label="出货重量"
                      align="center">
                      <template slot-scope="scope">
                        <el-input size="mini" v-model.trim="scope.row.shipmentWeight" disabled></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column
                      label="出货数量"
                      align="center">
                      <template slot-scope="scope">
                        <el-input size="mini" v-model.trim="scope.row.count" disabled></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column
                      ...
                      align="center">
                      <template slot-scope="scope">
                        <el-input size="mini" v-model.trim="scope.row[index]" disabled></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column
                      label="操作"
...
export default {
  ...
  methods: {
    ...
    getAllOrdersDetail(refreshData, params) {
      this.Axios.get('/order/orders/history', params)
        .then(res => {
          let result = res.data
          if (result.code == 0) {
