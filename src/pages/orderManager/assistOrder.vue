  ...
  <div class="sellOrder">
    <div class="headerWrapper">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>协助订单</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
            ...
            <template slot="title">
              <div class="header">
                ...
                <div class="item waitDetail">
                  ...
                  <span class="detail haveFollow" v-else-if="order.orderStatus == 3">已跟进</span>
                  <span class="detail haveCancel" v-else-if="order.orderStatus >= 10">已取消</span>
                </div>
              </div>
            </template>
            <div class="content">
              <div class="title" v-if="order.orderStatus == 0 || order.orderStatus == 10">
                <span>出货明细详情</span>
              </div>
              <div class="detail" v-if="order.orderStatus == 0 || order.orderStatus == 10">
                <div class="left">
                  <div
                    class="item bt-hover"
                ...
                <div class="right">
                  <div class="optionWrapper">
                    ...
                    <div class="btns">
                      <el-button type="primary" size="mini" plain @click="addDetail" v-if="order.orderStatus != 10">添加明细</el-button>
                    </div>
                  </div>
                  <el-table
                    :data="addSpeciDatas"
                    ...
                    <el-table-column
                      ...
                      <template slot-scope="scope">
                        <el-input size="mini" v-model.trim="scope.row.productWeight" :disabled="order.orderStatus == 10"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column
                      label="出货重量"
                      align="center">
                      <template slot-scope="scope">
                        <el-input size="mini" v-model.trim="scope.row.shipmentWeight" :disabled="order.orderStatus == 10"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column
                      label="出货数量"
                      align="center">
                      <template slot-scope="scope">
                        <el-input size="mini" v-model.trim="scope.row.count" :disabled="order.orderStatus == 10"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column
                      ...
                      align="center">
                      <template slot-scope="scope">
                        <el-input size="mini" v-model.trim="scope.row[index]" :disabled="order.orderStatus == 10"></el-input>
                      </template>
                    </el-table-column>
                    <el-table-column
                      label="操作"
                  ...
                  <div class="submitDetail">
                    <el-button type="primary" size="mini" plain @click="submitDetail" v-if="order.orderStatus != 10">提交明细</el-button>
                  </div>
                </div>
              </div>
              <div class="total">
...
export default {
  ...
  methods: {
    ...
    getAllOrdersDetail(refreshData, params) {
      this.Axios.get('/order/orders/assign', params)
        .then(res => {
          let result = res.data
          if (result.code == 0) {
